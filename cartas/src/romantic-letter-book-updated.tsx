...
// Componente de Partículas/Pétalos flotantes
...
const LoveLetterBook = () => {
  ...
  const isLetterUnlocked = (letterNumber: number) => {
  ...
  const getDaysUntilUnlock = (letterNumber: number) => {
    const letterDate = new Date(startDate);
    letterDate.setDate(startDate.getDate() + letterNumber - 1);
    letterDate.setHours(0, 0, 0, 0);
    const diffTime = letterDate.getTime() - today.getTime();
  ...
  // Cover View - Con gradiente azul oscuro
  if (currentView === 'cover') {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-900 via-slate-800 to-blue-950 flex items-center justify-center p-4 relative overflow-hidden">
        <FloatingPetals />
        <div className={`max-w-md w-full bg-white rounded-3xl shadow-2xl p-8 transition-all duration-500 animate-fade-in-scale ${pageTransition ? 'opacity-0 scale-95' : 'opacity-100 scale-100'}`}>
          <div className="text-center space-y-6">
            <div className="relative">
              <Sparkles className="w-8 h-8 text-blue-400 absolute -top-4 -left-4 animate-glow" />
              <Sparkles className="w-6 h-6 text-sky-400 absolute -top-2 -right-2 animate-glow" style={{animationDelay: '0.5s'}} />
              <Heart className="w-20 h-20 text-blue-500 mx-auto animate-heartbeat-custom" />
            </div>
            
            <h1 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-sky-400" style={{fontFamily: 'cursive'}}>
              Nuestras 30 Cartas
            </h1>
            
            <div className="space-y-2">
              <p className="text-gray-600 italic text-lg" style={{fontFamily: 'cursive'}}>
                Para el amor de mi vida
              </p>
              <p className="text-2xl text-blue-500 font-bold animate-float-up">💕</p>
            </div>
            
            <div className="bg-gradient-to-r from-blue-50 to-sky-50 rounded-2xl p-6 space-y-3 border border-blue-200">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-blue-600 to-sky-500 text-white py-4 rounded-full font-semibold flex items-center justify-center gap-2 hover:from-blue-700 hover:to-sky-600 transition-all shadow-lg hover:shadow-xl transform hover:scale-105 hover:shadow-blue-500/50"
  ...
  // Index View - Con gradiente azul oscuro
  if (currentView === 'index') {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-900 via-slate-800 to-blue-950 p-4 relative overflow-hidden">
        <FloatingPetals />
        <div className={`max-w-4xl mx-auto transition-all duration-500 ${pageTransition ? 'opacity-0 scale-95' : 'opacity-100 scale-100'}`}>
          <div className="bg-white rounded-3xl shadow-2xl p-6 md:p-8">
            <div className="flex items-center justify-between mb-6">
              <button
                onClick={goToCover}
                className="text-blue-600 hover:text-blue-700 flex items-center gap-2 transition-all hover:gap-3"
                style={{fontFamily: 'cursive'}}
              >
                <ChevronLeft className="w-5 h-5" />
                Volver
              </button>
              <h2 className="text-2xl md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-sky-400" style={{fontFamily: 'cursive'}}>
                Índice de Cartas
              </h2>
                ...
                return (
                  <button
                    ...
                    className={`relative aspect-square rounded-2xl p-4 transition-all duration-300 ${
                      unlocked
                        ? 'bg-gradient-to-br from-blue-500 to-sky-400 hover:from-blue-600 hover:to-sky-500 shadow-lg hover:shadow-xl transform hover:scale-110 cursor-pointer animate-fade-in-scale'
                  ...
                  >
                    <div className="flex flex-col items-center justify-center h-full text-white">
                      {unlocked ? (
                        <>
                          <Heart className="w-6 h-6 mb-2 animate-heartbeat-custom" />
  ...
  // Letter View - Con gradiente azul oscuro
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-900 via-slate-800 to-blue-950 p-4 relative overflow-hidden">
        ...
        <div className={`max-w-2xl mx-auto transition-all duration-500 ${pageTransition ? 'opacity-0 scale-95' : 'opacity-100 scale-100'}`}>
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 relative overflow-hidden">
            {/* Decorative elements - Azul oscuro */}
            <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-blue-200 to-sky-200 rounded-full blur-3xl opacity-50"></div>
            <div className="absolute bottom-0 left-0 w-32 h-32 bg-gradient-to-tr from-blue-200 to-sky-200 rounded-full blur-3xl opacity-50"></div>
            ...
            <div className="relative z-10">
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-2 text-blue-500 animate-slide-in-right">
                  <Heart className="w-5 h-5 fill-current animate-heartbeat-custom" />
              ...
              <div className="text-center mb-8 animate-slide-in-left">
                <h2 className="text-3xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-sky-400 mb-2" style={{fontFamily: 'cursive'}}>
                  {selectedLetter.title}
                </h2>
                <div className="flex items-center justify-center gap-2 text-sky-400">
                  <span className="text-2xl animate-float-up">✨</span>
                  <span className="text-2xl animate-heartbeat-custom">💕</span>
                  <span className="text-2xl animate-float-up" style={{animationDelay: '1s'}}>✨</span>
                </div>
              </div>

              {/* Letter Content */}
              <div className="prose prose-lg max-w-none animate-fade-in-scale">
              ...
              <div className="mt-8 text-right animate-slide-in-right">
                <p className="text-gray-600 italic" style={{fontFamily: 'cursive', fontSize: '1.2rem'}}>
                  Con todo mi amor,
                </p>
                <p className="text-2xl text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-sky-400 font-bold mt-2 animate-glow" style={{fontFamily: 'cursive'}}>
                  Tu amor 💕
                </p>
              </div>
